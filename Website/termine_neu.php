<html lang="de">
	...
	<body>
		...
		<ol class="breadcrumb">
			...
			<li><a href="termine_index.html">Terminplanung</a></li>
		...
		<div class="remodal" data-remodal-id="modalHinz">
			...
			<br />
			<br />
			<button data-remodal-action="confirm" class="remodal-confirm" onclick="location.href='termine_index.html';">OK</button>
		</div>
		...
		<div class="remodal" data-remodal-id="modalAbr">
			...
			<br />
			<br />
			<button data-remodal-action="cancel" class="remodal-cancel" onclick="location.href='termine_index.html';">OK</button>
		</div>
