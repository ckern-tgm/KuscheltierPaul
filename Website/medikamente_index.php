<<<<<<< HEAD:Website/medikamente_index.php
<html lang="de">
	<head>
	...
	<body>
		...
		<div class="navbar navbarOne">
			...
			<!--<button onclick="document.location = 'medikamente_index.html#img1'" style="float: right">Hilfe</button>-->
		</div>
		...
		<!--
		<div class="alert alert-success alert-dismissible" role="alert">Medikament erfolgreich hinzugefügt.</div>
		<div class="alert alert-danger alert-dismissible" role="alert">Medikament hinzufügen fehlgeschlagen.</div>
		-->
		...
		<button type="button" class="btn btn-info btn-lg btn-block" onclick="location.href='medikamente_neu.html';">
...
>>>>>>> d9c4c4a3a1538f1293c259820832625b8ce6c9f5:Website/medikamente_index.html
</html>