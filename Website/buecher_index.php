...
<html lang="de">
	...
	<body>
		...
		<div class="navbar navbarTwo" title="Menubar">
			...
			<a href="buecher_index.php" class="choosen" accesskey="4" title="Zur Buecherseite">
		...
		<div title="Headline">
			<h1>
				<svg xmlns="http://www.w3.org/2000/svg" alt="Bücher vorlesen" class="headline_svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><defs><path id="a" d="M0 0h24v24H0V0z"/></defs><clipPath id="b"><use xlink:href="#a" overflow="visible"/></clipPath><path clip-path="url(#b)" d="M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-1zm0 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5v11.5z"/></svg>
		...
		<div title="Search a book">
            <form method="GET" style="margin: 40px">
                ...
                <button type="submit" class="btn btn-info btn-lg btn-block" accesskey="6">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="btn_svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
					  <g>
