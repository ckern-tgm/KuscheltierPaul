...
<html lang="de">
	...
	<body>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="submit" form="passwordForm" class="btn btn-primary submitBtn" accesskey="7">Prüfen</button>
						<button type="button" class="btn btn-default" id="dd" data-dismiss="modal" accesskey="8">Abbrechen</button>
					</div>
				</div>
			</div>
		</div>

		<button type="button" class="btn btn-info btn-lg btn-block" data-toggle="modal" data-target="#pwdForm" accesskey="6">
		...
		<div class="table-responsive" id="scroll"  title="Information von Kuscheltierbesitzer">
		...
		<div class="table-responsive" id="scroll" title="Information von Notfallkontakt">
			<table class="table table-dark table-bordered table-hover table-striped">
				<thead class="tablehead">
					<tr>
