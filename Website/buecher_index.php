		...
		<div title="Search a book">
            <form method="GET" style="margin: 40px">
                ...
                <button type="submit" class="btn btn-info btn-lg btn-block">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" style="width: 2.5vw; height: 2.5vw;" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
					  <g>
