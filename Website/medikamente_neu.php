...
<html lang="de">
	...
	<body>
		...
		<div class="remodal" data-remodal-id="modalHinz">
			...
			<br />
			<br />
			<button data-remodal-action="confirm" class="remodal-confirm" onclick="location.href='medikamente_index.php';" accesskey="8">OK</button>
		</div>
		...
		<div class="remodal" data-remodal-id="modalAbr">
			...
			<br />
			<br />
			<button data-remodal-action="cancel" class="remodal-cancel" onclick="location.href='medikamente_index.php';" accesskey="9">OK</button>
		</div>
		...
		<form id="scroll" class="inputform" action="medikamente_neu_validation.php" method="post" title="New Drug add Form">
			...
			<div class="form-group" title="Add or Cancel">
				<div class="form-group col-md-6" title="Add">
					<!--<a href="#modalHinz">-->
						<button type="submit" name="submit" id="submit" data-toggle="modal" data-target="#modalHinz" class="btn btn-success btn-lg btn-block" accesskey="6">
