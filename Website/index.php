...
<html lang="de">
	...
	<body>
		...
		<p class="indexBackground" title="How does Paul work?">
			...
			Funktionen um den Senioren den Alltag zu erleichtern, wie eine <a href="medikamente_index.php">Medikamentenerinnerung</a>
			oder einen <a href="termine_index.php">Terminplaner</a>.
			Aus Unterhaltungszwecken kann man mit dem Kuscheltier Simon says spielen und sich <a href="buecher_index.php">Hörbücher
				anhören</a>.
		...
		<p class="indexBackground" title="Einzigartigkeit und Innovation">
			...
			Diese sind aber
			Großteiles sehr teuer, unhandlich und für die ältere Generation schlichtweg unverständlich. Es gibt jedoch bereits
			spezielle
			Produkte zur Unterhaltung von Pensionisten, wie zum Beispiel einen Katzenroboter der Firma Hasbro oder einen
			Hunderoboter.
