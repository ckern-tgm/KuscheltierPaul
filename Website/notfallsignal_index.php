...
<script language="JavaScript">
    function check() {
        ...
        $.ajax({
            ...
            data: {input: document.getElementById("pwd").value},
            type: "POST"
        });
...
<div class="navbar navbarTwo">
    ...
    <a href="buecher_index.php">
        <svg xmlns="http://www.w3.org/2000/svg" alt="Bücher vorlesen" width="35" height="35"
...
<div class="remodal" data-remodal-id="modalPwd">
    ...
    <form method="post" action="passwortCheck.php">
        <input type="password" class="form-control form-control-lg" name="pwd" id="pwd" placeholder="Passwort"
               required/>
        <br/>
        <button data-remodal-action="confirm" class="remodal-confirm">Prüfen</button>
    </form>
